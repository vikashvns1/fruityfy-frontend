...
const FeaturedSection = () => {
  ...
  return (
    <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12 ${isRTL ? 'text-right' : 'text-left'}`}>
      ...
      <section>
        <div className={`flex items-center justify-between mb-6 ${isRTL ? 'flex-row-reverse' : ''}`}>
          ...
          <button className="text-primary text-sm font-semibold flex items-center gap-1 hover:gap-2 transition-all">
            {t('common.view_all')} {isRTL ? <ArrowLeft size={16} /> : <ArrowRight size={16} />}
          </button>
        </div>
