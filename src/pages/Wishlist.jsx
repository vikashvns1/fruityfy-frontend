...
const Wishlist = () => {
    ...
    return (
        <div className={`min-h-screen bg-gray-50 pt-20 pb-10 px-4 md:px-8 ${isRTL ? 'text-right' : 'text-left'}`}>
            <div className="max-w-6xl mx-auto">
                ...
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-20 bg-white rounded-lg shadow-sm">
                        ...
                        <p className="text-gray-500 mb-6">
                            {isRTL ? 'احفظ المنتجات التي تحبها لشرائها لاحقاً.' : 'Save items you love to buy them later.'}
                        </p>
                        <button 
                            onClick={() => navigate('/shop')}
                            className={`flex items-center gap-2 bg-green-600 text-white px-6 py-2.5 rounded-full hover:bg-green-700 transition-colors ${isRTL ? 'flex-row-reverse' : ''}`}
                        >
                            <ShoppingBag size={20} />
